...
const media = [
  new Resource(
    "http://inrupt.luispc1998/routeMedia/image/<comentarioConSuTipo>"
  ),
  new Resource(
    "http://inrupt.angelixus/routeMedia/image/<comentarioConSuTipo>"
  ),
  new Resource("http://inrupt.raupemol/routeMedia/video/<comentarioConSuTipo>"),
  new Resource(
    "http://inrupt.luispc1998/routeMedia/video/<comentarioConSuTipo>"
  ),
];
